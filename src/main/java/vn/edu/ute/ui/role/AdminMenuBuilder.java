...
/**
 * OCP: MenuBuilder cho Admin — thêm/sửa tab chỉ cần sửa class này,
 * KHÔNG cần sửa MainFrame.
 */
public class AdminMenuBuilder implements MenuBuilder {
    ...
    public void buildMenu(JTabbedPane tabbedPane, UserAccount currentUser) {
        addTab(tabbedPane, "  Nhân viên  ", new StaffPanel(staffService), "Thêm/Sửa/Xóa Nhân viên");
        addTab(tabbedPane, "  Tài khoản  ", new UserAccountPanel(userAccountService), "Thêm/Sửa/Xóa Tài khoản");
