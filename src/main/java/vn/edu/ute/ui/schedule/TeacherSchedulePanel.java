 ...
 * Chỉ hiển thị lịch của teacher hiện tại.
 */
public class TeacherSchedulePanel extends JPanel {

    private final ScheduleService scheduleService;
    private final Long teacherId;
    private final ScheduleTableModel tableModel = new ScheduleTableModel(false); // Không cần cột Giáo viên (vì chính
                                                                                 // họ)
    ...
    private void loadData() {
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "Lỗi tải lịch dạy: " + ex.getMessage(),
