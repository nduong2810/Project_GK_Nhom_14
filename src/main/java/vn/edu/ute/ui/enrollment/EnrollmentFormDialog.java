...
public class EnrollmentFormDialog extends JDialog {
    ...
    public EnrollmentFormDialog(Frame owner, String title, Enrollment existing, List<Student> students, List<ClassEntity> classes) {
    ...
    private void buildUI() {
        ...
        int r = 0;
        g.gridx = 0; g.gridy = r; form.add(new JLabel("Học Viên (*):"), g);
        ...
        r++;
        g.gridx = 0; g.gridy = r; form.add(new JLabel("Ngày Ghi Danh:"), g);
    ...
    private void onSave() {
        try {
            ...
            } catch (Exception ex) { throw new IllegalArgumentException("Ngày ghi danh không đúng định dạng dd/MM/yyyy"); }
